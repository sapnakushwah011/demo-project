...
test.describe("PaginateAutoComplete Component", () => {
  ...
  test("should render Autocomplete with default props", async () => {
  ...
  test("should render placeholder", async () => {
    // Verify component renders with default placeholder
    const autocomplete = page.locator('input[id="Demo-parent_account_id"]');
    await expect(autocomplete).toHaveAttribute(
      "placeholder",
      "-- Select One --"
    );
  });
  ...
  test("should fetch data when opened", async () => {
  ...
  test("should fetch and filter results based on search input", async () => {
  ...
  test("should load more options when scrolling", async () => {
  ...
  test("should clear search and reset data when input is cleared", async () => {
